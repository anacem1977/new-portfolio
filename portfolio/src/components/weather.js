...
render () {
    return (
        <div className="subtitle">
            <div>
                <h3>Weather App</h3>
                <p>This was a task for a company that I was interviewing with, and the goal was to create a React app using Open Weather Map API to retrieve current and forecasted weather conditions for any given location.</p>
