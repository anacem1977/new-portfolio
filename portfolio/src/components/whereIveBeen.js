    ...
    return (
        <div className="subtitle">
            <div>
                ...
                <p>During this time, I've also had the opportunity to participate in numerous projects such as SAP implementation, sunset of one of the engines that was produced at the factory, asset management and many more. →<Link to = "resume"> Read more</Link></p>
