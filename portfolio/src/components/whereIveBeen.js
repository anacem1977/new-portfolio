    ...
    return (
        <div className="subtitle">
            <div>
                ...
                <p>Part of being curious is that I love learning new stuff: I'm <em>almost</em> level B1 in French, I have a Diploma on Data Science and I've decided to take a big turn in my careeer so, I recently finished the Software Engineering Immersive Reskilling Program with <a href="https://generalassemb.ly/" className="ga" target="_blank" rel="noreferrer">General Assembly</a> (they are awesome!)</p>
            </div>
        </div>
